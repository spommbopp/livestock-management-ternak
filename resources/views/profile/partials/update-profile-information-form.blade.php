<section>
    <p class="text-sm text-stone-500 mb-6">
        Perbarui nama dan alamat email akun peternakan Anda.
    </p>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="space-y-5">
        ...
        <div>
            <x-input-label for="name" value="Nama" class="text-stone-700" />
            <x-text-input
                id="name"
                name="name"
                type="text"
            ...
            @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
                <div class="mt-3 rounded-lg bg-amber-50 border border-amber-200 px-4 py-3">
                    <p class="text-sm text-amber-800">
                        ...
                        <button form="send-verification" class="underline font-medium hover:text-amber-950 focus:outline-none focus:ring-2 focus:ring-green-600 rounded">
